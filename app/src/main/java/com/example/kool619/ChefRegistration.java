...
public class ChefRegistration extends AppCompatActivity {
    ...
    String fname,lname,emailid,password,confpassword,mobile,house,Area;
    String role="Chef";
                                                        ...
                                                        if(task.isSuccessful()){
                                                            ...
                                                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    b.putExtra("phonenumber", "+216"+mobile);
                                                                    startActivity(b);
                                                                }
                                                            });
    ...
    public boolean isValid(){
        ...
        isValid = isValidconfpassword && isValidpassword && isValidemail && isValidmobilenum && isValidname && isValidhouseno && isValidlname;
        return isValid;
